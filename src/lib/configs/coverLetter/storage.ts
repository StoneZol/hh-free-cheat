...
Структура (строго):
- Первая строка письма — приветствие на языке вакансии (например, Hello! или Здравствуйте!).
- Исключение: если вакансия явно просит кодовое слово или ответ в сопроводительном — тогда сначала эта строка, пустая строка, затем приветствие на языке вакансии.
